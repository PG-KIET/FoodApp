...
import com.example.ecofood.databinding.NotificationItemBinding
...
class NotificationAdapter(private var notification: ArrayList<String>, private var notificationImage: ArrayList<Int>) :
    ...
    override fun getItemCount(): Int {
        // Return the size of the notification list (or notificationImage, assuming they are the same size)
